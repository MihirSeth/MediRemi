...
class DatabaseService {
  ...
  Future<void> appointmentData(String doctorsName,String appointmentReason, String doctorAddress, int timeHours, int timeMinutes, String timeType, String dayAppointment,int dateAppointment, int monthAppointment,int yearAppointment, timeDatabase, String uid) async {
